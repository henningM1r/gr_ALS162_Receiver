...
def decode_bitstream(bitstream, count):
    ...
    print("07-12: Always zero")
    if (bitstream[7] or bitstream[8] or bitstream[9] or
            bitstream[10] or bitstream[11] or bitstream[12] == 1):
        print("at least one bit in bits 07-12 is 1 instead of 0!")
        return

    if bitstream[13] == 1:
        print("the following day is a holiday")
    ...
    if bitstream[19] == 1:
        print("19: is 1 in stead of 0!")
        return

    if bitstream[20] == 1:
        print("20: Beginn of time information")
    elif bitstream[20] == 0:
        print("20: is 0 instead of 1!")
        return
    ...
    if (bitstream[21] ^ bitstream[22] ^ bitstream[23] ^
            bitstream[24] ^ bitstream[25] ^
            bitstream[26] ^ bitstream[27] ^ bitstream[28] == 0):
    ...
    print(f"Date: {day_dec10}{day_dec0}.{month_dec10}{month_dec0}"
          f".{year_dec10}{year_dec0}")
